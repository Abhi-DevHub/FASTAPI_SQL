...
Revision ID: a9a344a9be94
Revises: 
Create Date: 2025-07-09 11:54:59.340268
...
def upgrade() -> None:
    ...
    op.create_index('ix_bookmarks_user_id', 'bookmarks', ['user_id', 'created_at'], unique=False)
